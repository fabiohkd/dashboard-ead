...
<h1 class="text-3xl text-black pb-3">
	Dúvidas dos Alunos
</h1>
	...
	<form action="" method="get" class="w-full max-w-lg">
		<div class="flex flex-wrap -mx-3 mb-6">
				...
				<div class="w-full md:w-1/2">
						<button type="submit" class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">Filtrar</button>
				</div>
		</div>
	</form>
					...
					<tbody>
						@forelse ($supports->items() as $support)
							<tr>
									...
									<td class="px-5 border-b border-gray-200 bg-white text-sm">
										<a href="{{ route('admins.supports.show', $support->id) }}">
											<span
							...
							@empty
								<tr>
									<td colspan="1000">Sem Nenhum Suporte Para Listar!</td>
								</tr>
							@endforelse
						</tbody>
			</table>

...
@section('title', "Aulas - Módulo {$module->name}")
		
@section('content')

<h2 class="text-2xl text-black pb-3">
	Aulas - Módulo: <strong>{{$module->name}}</strong> 
			...
			<table class="min-w-full leading-normal">
					...
					<tbody>
						@forelse ($lessons as $lesson)
							...
							@empty
								<tr>
									<td colspan="1000">Nenhuma Aula Para Listar!</td>
								</tr>
							@endforelse

...
<div class="">
	...
	<input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="name" value="{{ $admin->name ?? old('name')}}"
	name="name" type="text" required placeholder="Nome" aria-label="Name">
</div>
<div class="mt-2">
	<label class="block text-sm text-gray-600" for="email">Email</label>
	<input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="email" value="{{ $admin->email ?? old('email')}}"
